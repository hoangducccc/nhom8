                                    ...
                                    <div class="row">
                                        <div class="product_active owl-carousel">
                                            <div class="col-lg-3">
                                                <div class="single_product">
                                                    <div class="product_thumb">
                                                        <a href="single-product-video.html"><img src="assets\img\product\product1.jpg" alt=""></a>
                                                        <div class="img_icone">
                                                    ...
                                                    <div class="product_content">
                                                        <span class="product_price_goc">1.999.000 VND</span>
                                                        <span class="product_price_dis">3.900.000 VND</span>
                                                        <h3 class="product_name">Máy đo đường huyết Accu Chek Guide</h3>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="single_product">
                                                    <div class="product_thumb">
                                                        <a href="single-product-video.html"><img src="assets\img\product\product3.jpg" alt=""></a>
                                                        <div class="img_icone">
                                                            <img src="assets\img\cart\span-new.png" alt="">
                                                        </div>
                                                        <div class="product_action">
                                                    ...
                                                    <div class="product_content">
                                                        <span class="product_price_goc">2.099.000 VND</span>
                                                        <span class="product_price_dis">2.200.000 VND</span>
                                                        <h3 class="product_name">Máy đo huyết áp Microlife B3 Afib Advance</h3>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="single_product">
                                                    <div class="product_thumb">
                                                        <a href="single-product-video.html"><img src="assets\img\product\product5.jpg" alt=""></a>
                                                        <div class="img_icone">
                                                            <img src="assets\img\cart\span-new.png" alt="">
                                                        </div>
                                                        <div class="product_action">
                                                    ...
                                                    <div class="product_content">
                                                        <span class="product_price_goc">699.000 VND</span>
                                                        <span class="product_price_dis">1.000.000 VND</span>
                                                        <h3 class="product_name">Máy đo huyết áp Sinocare BA-801</h3>
                                                        <!--<h3 class="product_title"><a href="single-product.html">Curabitur sodales</a></h3>-->
                                                    </div>
                                                    <div class="product_info">
                                                        <ul>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="single_product">
                                                    <div class="product_thumb">
                                                        <a href="single-product-video.html"><img src="assets\img\product\product7.jpg" alt=""></a>
                                                        <div class="img_icone">
                                                            <img src="assets\img\cart\span-new.png" alt="">
                                                        </div>
                                                        <div class="product_action">
                                                    ...
                                                    <div class="product_content">
                                                        <span class="product_price_goc">2.199.000 VND</span>
                                                        <span class="product_price_dis">2.350.000 VND</span>
                                                        <h3 class="product_name">Ghế Bô - Tắm đa năng GBM-016</h3>
                                                        <!--<h3 class="product_title"><a href="single-product.html">Curabitur sodales</a></h3>-->
                                                    </div>
                                                    <div class="product_info">
                                                        <ul>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="single_product">
                                                    <div class="product_thumb">
                                                        <a href="single-product-video.html"><img src="assets\img\product\product2.jpg" alt=""></a>
                                                        <div class="img_icone">
                                                            <img src="assets\img\cart\span-new.png" alt="">
                                                        </div>
                                                        <div class="product_action">
                                                    ...
                                                    <div class="product_content">
                                                        <span class="product_price_goc">2.599.000 VND</span>
                                                        <span class="product_price_dis">3.199.000 VND</span>
                                                        <h3 class="product_price">Máy trợ thính Newsound Vivo 201</h3>
                                                    </div>
                                                    <div class="product_info">
                                                        <ul>
                                                            <li><a href="#" title=" Add to Wishlist ">Yêu thích</a></li>
                                        ...
                                        <div class="product_active owl-carousel">
                                            <div class="col-lg-3">
                                                <div class="single_product">
                                                    ...
                                                    <div class="product_content">
                                                        <span class="product_price_goc">949.000 VND</span>
                                                        <span class="product_price_dis">1.200.000 VND</span>
                                                        <h3 class="product_name">Máy đo huyết áp bắp tay Beurer BM40</h3>
                                                        <!--<h3 class="product_title"><a href="single-product.html">Curabitur sodales</a></h3>-->
                                                    </div>
                                                    <div class="product_info">
                                                        <ul>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="single_product">
                                                    <div class="product_thumb">
                                                        <a href="single-product-video.html"><img src="assets\img\product\product8.jpg" alt=""></a>
                                                        <div class="hot_img">
                                                            <img src="assets\img\cart\span-hot.png" alt="">
                                                        </div>
                                                        <div class="product_action">
                                                    ...
                                                    <div class="product_content">
                                                        <span class="product_price_goc">1.200.000 VND</span>
                                                        <!-- <span class="product_price_dis">1.000.000 VND</span> -->
                                                        <h3 class="product_name">Máy đo nồng độ oxy trong máu Alvital</h3>
                                                        <!--<h3 class="product_title"><a href="single-product.html">Curabitur sodales</a></h3>-->
                                                    </div>
                                                    <div class="product_info">
                                                        <ul>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="single_product">
                                                    <div class="product_thumb">
                                                        <a href="single-product-video.html"><img src="assets\img\product\product4.jpg" alt=""></a>
                                                        <div class="hot_img">
                                                            <img src="assets\img\cart\span-hot.png" alt="">
                                                        </div>
                                                        <div class="product_action">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="single_product">
                                                    <div class="product_thumb">
                                                        <a href="single-product-video.html"><img src="assets\img\product\product6.jpg" alt=""></a>
                                                        <div class="hot_img">
                                                            <img src="assets\img\cart\span-hot.png" alt="">
                                                        </div>
                                                        <div class="product_action">
                                                    ...
                                                    <div class="product_content">
                                                        <span class="product_price_goc">1.699.000 VND</span>
                                                        <span class="product_price_dis">1.900.000 VND</span>
                                                        <h3 class="product_name">Ghế Bô - Tắm đa năng GBM-036</h3>
                                                        <!--<h3 class="product_title"><a href="single-product.html">Curabitur sodales</a></h3>-->
                                                    </div>
                                                    <div class="product_info">
                                                        <ul>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="single_product">
                                                    ...
                                                    <div class="product_content">
                                                        <span class="product_price_goc">1.999.000 VND</span>
                                                        <span class="product_price_dis">2.499.000 VND</span>
                                                        <h3 class="product_name">Máy đo đường huyết Accu Chek Guide</h3>
                                                        <!-- <span class="product_price-dis">3.900.000 VND</span> -->
                                                        <!--<h3 class="product_title"><a href="single-product-video.html">Curabitur sodales</a></h3>-->
                                                    </div>
                                                    <div class="product_info">
                                                        <ul>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-6 col-sm-6">
                                        <div class="footer_widget">
                                            <h3>Thông tin</h3>
                                            <p>Chúng tôi là DHD, luôn mang đến cho bạn những dịch vụ tuyệt vời nhất</p>
                                            <div class="footer_widget_contect">
                                                <p><i class="fa fa-map-marker" aria-hidden="true"></i>  1 Đại Cồ Việt</p>

                                                <p><i class="fa fa-mobile" aria-hidden="true"></i> (012) 234 432 3568</p>
                                                <a href="#"><i class="fa fa-envelope-o" aria-hidden="true"></i> duck31litq@gmail.com </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="footer_social text-right">
                                            <ul>
                                                <li><a href="https://www.facebook.com/duck31litq"><i class="fa fa-facebook"></i></a></li>
                                                <li><a href="https://www.instagram.com/dat_dt02/"><i class="fa fa-instagram"></i></a></li>
